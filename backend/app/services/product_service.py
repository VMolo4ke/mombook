...
from ..schemas.product import ProductResponse, ProsuctListResponse, ProductCreate
...
class ProductService:
    ...
    def get_all_products(self) -> ProsuctListResponse:
        products = self.product_repository.gel_all()
        products_response = [ProductResponse.model_validate(prod) for prod in products]
        return ProsuctListResponse(products=products_response, total=len(products_response))
    ...
    def get_product_by_category(self, category_id: int) -> ProsuctListResponse:
