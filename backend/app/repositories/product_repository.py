...
class ProductRepository:
    ...
    def get_by_category(self, catergory_id: int) -> List[Product]:
        return self.db.query(Product).options(joinedload(Product.category)).filter(Product.category_id == catergory_id).all()
